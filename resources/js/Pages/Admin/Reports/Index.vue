...
const queueExport = (type: 'tickets' | 'csat', format: 'csv' | 'pdf') => {
  router.post(route('admin.reports.exports.store'), { ...form.data(), type, format }, {
    preserveScroll: true,
...
<template>
  <AdminLayout title="Reports">
    <div>
      ...
      <p class="mt-1 text-sm text-muted-foreground">Export filtered tickets and CSAT results. Queued exports refresh automatically while running.</p>
    </div>
      ...
      <Card>
        <CardContent class="space-y-4 p-5">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <a :href="route('admin.reports.tickets.csv', params)" :class="directDownloadButtonClass"><Download class="h-4 w-4" /> CSV</a>
            <a :href="route('admin.reports.tickets.pdf', params)" :class="directDownloadButtonClass"><Download class="h-4 w-4" /> PDF</a>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent class="space-y-4 p-5">
          ...
          <div class="flex flex-wrap gap-2">
            ...
            <a :href="route('admin.reports.csat.csv', params)" :class="directDownloadButtonClass"><Download class="h-4 w-4" /> CSV</a>
            <a :href="route('admin.reports.csat.pdf', params)" :class="directDownloadButtonClass"><Download class="h-4 w-4" /> PDF</a>
          </div>
        </CardContent>
      </Card>
    </div>
